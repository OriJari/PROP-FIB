...
public class Driverslopeone {
    ...
    public static void testSlopeOne_250() {
        ...
        CSVparserRate csv = new CSVparserRate("persistencia/movie.sample/250/ratings.test.known.csv");
        csv.readLoadRate();
    ...
    public static void testSlopeOne_csv() {
        ...
        boolean salir = false;
        sc = new Scanner(System.in);
        CSVparserRate csv = new CSVparserRate("persistencia/movie.sample/750/ratings.test.known.csv");
        csv.readLoadRate();
        csv.LoadRate(csv.getContent());
