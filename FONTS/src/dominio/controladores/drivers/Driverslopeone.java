...
public class Driverslopeone {
    ...
    public static void testSlopeOne_250() {
        ...
        CSVparserRate csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/F250/ratings.test.known.csv");
        csv.readLoadRate();
    ...
    public static void testSlopeOne_csv() {
        ...
        boolean salir = false;
        sc = new Scanner(System.in);
        CSVparserRate csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/F750/ratings.test.known.csv");
        csv.readLoadRate();
        csv.LoadRate(csv.getContent());
