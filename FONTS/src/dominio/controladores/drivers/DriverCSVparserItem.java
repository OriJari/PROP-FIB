...
public class DriverCSVparserItem {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CSVparserItem csv = new CSVparserItem("dominio/controladores/vcont/prova1item.csv");
            csv.readLoadItem();
                ...
                try {
                    switch (op) {
                        case "0" : finish = true;
                            break;
                        case "1" :
                            csv = new CSVparserItem("dominio/controladores/vcont/prova1item.csv");
                            csv.readLoadItem();
                            csv.MapItemData(csv.getContent());
                            System.out.println("CSV prueba 1 cargado");
                            break;
                        case "2" :
                            csv = new CSVparserItem("dominio/controladores/vcont/prova2item.csv");
                            csv.readLoadItem();
                            csv.MapItemData(csv.getContent());
                            System.out.println("CSV prueba 2 cargado");
                            break;
                        case "3" :
                            csv = new CSVparserItem("dominio/controladores/vcont/prova3item.csv");
                            csv.readLoadItem();
                            csv.MapItemData(csv.getContent());
                            System.out.println("CSV prueba 3 cargado");
                            break;
                        case "4" :
                            csv = new CSVparserItem("dominio/controladores/vcont/prova4item.csv");
                            csv.readLoadItem();
                            csv.MapItemData(csv.getContent());
