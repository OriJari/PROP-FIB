...
public class DriverCSVparserRate {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CSVparserRate csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/prova1rating.csv");
            csv.readLoadRate();
                ...
                try {
                    switch (op) {
                        case "0" : finish = true;
                            break;
                        case "1" :
                            csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/prova1rating.csv");
                            csv.readLoadRate();
                            csv.LoadRate(csv.getContent());
                            System.out.println("Pruba 1 cargada");
                            break;
                        case "2" :
                            csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/prova2rating.csv");
                            csv.readLoadRate();
                            csv.LoadRate(csv.getContent());
                            System.out.println("Pruba 2 cargada");
                            break;
                        case "3" :
                            csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/prova3rating.csv");
                            csv.readLoadRate();
                            csv.LoadRate(csv.getContent());
                            System.out.println("Pruba 3 cargada");
                            break;
                        case "4" :
                            csv = new CSVparserRate("FONTS/src/dominio/controladores/vcont/prova4rating.csv");
                            csv.readLoadRate();
                            csv.LoadRate(csv.getContent());
